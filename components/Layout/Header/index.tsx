      ...
      <Link href="#" className="hover:underline hover:font-[700] font-[600] text-[16px]">
        Programs
            ...
            {activeDropdown === "programs" && (
              <ul ref={dropdownRef} className="absolute left-0 top-full w-[250px] px-2.5 py-10 bg-white text-[#00712D] text-[18px] font-[900] rounded-[10px] border-[rgba(0, 113, 45, 0.50)] shadow-[3px 3px 2px 0px rgba(0, 113, 45, 0.30)] z-50">
                <li>
